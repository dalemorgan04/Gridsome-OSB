      ...
      <div class="contact-container accent-bottom">
        ...
        <div class="static-container">
          <div class="form-group row">
            <label for="staticEmail" class="col-sm-4 col-form-label p">Email</label>
            <div class="col-sm-8">
              <input type="text" readonly class="form-control-plaintext p" id="staticEmail" value="info@osb-architects.co.uk">
            </div>
          </div>        
          <div class="form-group row">
            <label for="call" class="col-sm-4 col-form-label p">Call</label>
            <div class="col-sm-8">
        ...
        >
          ...
          <div class="button-container clearfix">
            <button type="submit" class="btn btn-primary btn-lg shadow float-right">Send</button>
          </div>
